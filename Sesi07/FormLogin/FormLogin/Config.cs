   ...
   public class Config
    {
        ...
        public string user1 = "root";// MySQL user
        ...
        public void Connect(string database_name)
        {
            try
            {
                ConectionString = "SERVER=" + server + ";" + "DATABASE=" + database_name + ";" + "UID=" + user1 + ";" + "PASSWORD=" + password + ";";
        ...
        // Function to execute select satements
        public void ExecuteSql(string Sql_command)
        {
            noowquiee(Sql_command);
        }
        // creates connection to MySQL before execution
        public void noowquiee(string sql_comm)
        {
            try
            {
