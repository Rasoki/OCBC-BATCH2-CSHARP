...
using PaymentAPIWithJWT3.Models.DTOs.Requests;
using PaymentAPIWithJWT3.Models.DTOs.Responses;


namespace PaymentAPIWithJWT3.Controllers
{
    ...
    public class AuthManagementController : ControllerBase
    {
        ...
        private async Task<AuthResult> VerifyAndGenerateToken(TokenRequest tokenRequest)
        {
            ...
            try
            {
                ...
                // Validation 2 - Validate encrypytion alg
